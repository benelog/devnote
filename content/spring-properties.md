\[시대 착오적인 설정 파일 \*.properties를
버리자\](<http://kwon37xi.egloos.com/4665590>) 참조

스프링에서는 \<context:property-placeholder/\>, \<util:properties/\>,
국제화 메시지용 Resource Bundle에서 모두 'Properites XML’형식을
지원합니다. 3.1에서는 \<context:property-placeholder/\>와
@PropertySource를 썼을 때 'Properties XML' 형식이 인식이 안 되는 버그가
있었습니다. 3.1.2에서 이를 회피하는 방법은
\<[http://wiki.kwonnam.pe.kr/springframework/propertysource\>를](http://wiki.kwonnam.pe.kr/springframework/propertysource>를)
