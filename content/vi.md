...
\+ : 다음줄의 첫문자 - : 전줄의 첫문자 0 : 현재줄의 첫문자 (Home) \$ :
현재줄의 마지막 문자 G: 마지막줄의 첫문자 3+ : 3줄아래 H : 화면의 맨위
라인 L : 화면의 맨 아래 라인 M :ghkausdml wndrks ^L : 현재화면 다시 ^B :
한 화면 위 ^F : 한 화면 아래

### 입력

o : 아래라인 I : 현재라인의 첫문자 A : 현재라인의 마지막 O : 현재라인의
위
...
yw : 단어 복사 yy : 라인 복사 p : 붙여넣기. P : 현재 커서 앞에 붙여넣기
J : 현재라인과 다음라인 연결
...
<http://blog2book.hanb.co.kr/191>http://blog2book.hanb.co.kr/191\[VIM에서
자동완성 기능 사용하기\]
