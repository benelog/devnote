...
<http://onestepback.org/articles/quickrails/takahashi.xul?data=quickrails.data#1>

루비한글사이트(quickstart) :
<http://www.ruby-lang.org/ko/documentation/quickstart/>

루비연습 : <http://tryruby.hobix.com/>

루비 블로그 : <http://beyond.daesan.com/pages/ruby-faq>
...
[Ruby on Rails and J2EE: Is there room for
both?](http://www-128.ibm.com/developerworks/web/library/wa-rubyonrails/)

루비를 이용한 Behavior Driven
Developmenthttp://network.hanb.co.kr/view.php?bi_id=1458\[
<http://network.hanb.co.kr/view.php?bi_id=1458>\]
<http://network.hanb.co.kr/view.php?bi_id=1459>
...
[레일스로 이메일 받아 처리하기](http://thinkr.egloos.com/1811596)

[배우(actor)가 된 루비, Revactor](http://thinkr.egloos.com/1878511)

[루비가 얼랭에 빠졌던 이유?](http://thinkr.egloos.com/1954598)

[클로저 (Closure) - 마틴 파울러](http://newlord.egloos.com/1978181)

[Ruby on
Rails](http://wiki.rubyonrails.org/rails/pages/HowtoConfigureLogging)

[Debugging with ruby-debug](http://railscasts.com/episodes/54)

[HowtoDebugWithRubyDebug](http://wiki.rubyonrails.org/rails/pages/HowtoDebugWithRubyDebug)

[HowtoConfigureLogging](http://wiki.rubyonrails.org/rails/pages/HowtoConfigureLogging)

[The Ruby on Rails Link Library](http://labuschin.com/rails)

[Rails + Merb, 또 하나의 인수합병](http://thinkr.egloos.com/2180851)
...
[레일스 테스팅 참고자료](http://thinkr.egloos.com/2011191)

<http://www.nomedojogo.com/2008/06/15/ruby-on-rails-21-whats-new-second-edition/>

<http://giantrobots.thoughtbot.com/2008/6/19/gotchas-when-upgrading-to-rails-2-1>

[Learning Rails +
Heroku](http://lastmind.net/blog/2009/02/learning-rails-heroku.html)
