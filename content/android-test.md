...
하나만: adb shell am instrument -w -e class
com.example.aatg.myfirstproject.test.MyFirstProjectTests
com.example.aatg.myfirstproject.
...
[안드로이드에서 단위테스트를 위한 Junit 사용하기
(1)](http://mainia.tistory.com/490)

[안드로이드에서 단위테스트를 위한 Junit 사용하기
(2)](http://mainia.tistory.com/487)

<http://developer.android.com/resources/tutorials/testing/helloandroid_test.html>

[안드로이드 테스트 - Hello, Testing](http://huewu.blog.me/110089690999)

<http://developer.android.com/guide/topics/testing/testing_android.html>

[안드로이드 테스트 - Testing and Instrumentation
소프트웨어](http://blog.naver.com/huewu/110089444708)
...
번역 : <http://blog.naver.com/huewu/110089695301>
,http://blog.naver.com/huewu/110089769967\[<http://blog.naver.com/huewu/110089769967>\]
...
[안드로이드 unit test 에서 async task 결과를
테스트하기](http://kingori.egloos.com/4554640)

[Android, Unit test 대상 로직에서 Handler 사용 시 멈추는 문제
해결](http://kingori.egloos.com/4577436)
...
startService(Intent) 혹은 bindService(Intent)를 부르면 onCreate가
호출된다.
...
=== [LMock](https://github.com/vmware/lmock)

- Jmock 스타일, Mockito 스타일 다 가능.
- VMWare에서 만들었음. 문서화는 부족하나 예제는 잘 정리되어 있음.
- [예제](https://github.com/vmware/lmock/blob/master/examples/com/vmware/lmock/example/geek/GeekDayTest.java)
